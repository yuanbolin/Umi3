      ...
      <div className={styles.contentbox}>
        ...
        <div className={styles.middle}>
          ...
          <Form {...formItemLayout}>
            <Row>
              <Col span={10} offset={1}>
                <Form.Item label='上级公司'>
                  {getFieldDecorator('parentCode', { initialValue: data.parentCode })(<CompanyTreeSelect mode='companyCode' />)}
                </Form.Item>
              </Col>
              <Col span={10}>
                <Form.Item label='状态'>
            ...
            <Row>
              <Col span={10} offset={1}>
                <Form.Item label='归属区域'>{getFieldDecorator('areaCode', { initialValue: data.areaCode })(<Search allowClear />)}</Form.Item>
              </Col>
              <Col span={10}>
                <Form.Item label='包含机构'>
                  {getFieldDecorator('sysOfficeIds', { initialValue: data.sysOfficeIds })(<OrgTreeSelect mode='id' treeCheckable />)}
                </Form.Item>
              </Col>
            </Row>
            <Row>
              <Col span={20} offset={1}>
                <Form.Item label='备注信息' wrapperCol={{ span: 19 }} labelCol={{ span: 3 }}>
                  {getFieldDecorator('remarks', { initialValue: data.remarks })(<TextArea rows={4} allowClear />)}
                </Form.Item>
              </Col>
            </Row>
          </Form>
